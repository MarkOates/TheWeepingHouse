...
AllegroFlare::Prototypes::FixedRoom2D::Configuration ConfigurationsBuilder::build()
{
   ...
   room_dictionary = {
      //{ FRONT_PORCH, room_factory.create_room() },
   ...
   entity_dictionary = {
      //{ "front_porch_bg", entity_factory.create_background("room_2.png", "observe_front_porch") },
   ...
   script_dictionary = {
      //{ "observe_front_porch", AllegroFlare::Prototypes::FixedRoom2D::Script({
